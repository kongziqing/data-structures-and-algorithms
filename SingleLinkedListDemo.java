...
//本代码为单链表的增删改查
//面试算法题
//1.获取单链表节点的个数（如果是带头节点的链表，需求不统计头节点）
//2.查找单链表中的倒数第K个节点【新浪面试题】
//3.单链表的反转【腾讯面试题，有点难度】
//4.从尾到头，打印单链表【百度，要求方式1：反向遍历，方式2：stack栈】
...
//        singleLinkedList.list();
    ...
    //面试题1：获取单链表的节点的个数（如果是带头节点的链表，需求不统计头节点）
      ...
      * 4.得到size后,我们从链表的第一个开始遍历（size-index）个就可以得到了
    ...
    public static void reverseList(HeroNode head){
        ...
        while(cur != null){
            ...
            reverseHead.next = cur;//将cur连接到新的链表的上
            cur = next;//让cur后移
        }
        //将head.next指向reversHead.next,实现单链表的反转
    ...
    public static void reversePrint(HeroNode head){
        ...
        while(cur!=null){
            stack.push(cur);
            cur = cur.next;//让cur后移，就可以压入后一个节点        }
    }
        //将栈中的节点进行打印，pop出栈
        while(stack.size()>0){
